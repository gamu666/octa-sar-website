...
const works = [
  { id: 'content-factory', name: 'Content Factory', meta: 'Content production system · 2026', summary: 'Контент захиалга, production үе шат, зураг авалт, төлбөр, бэлэн болсон бичлэг болон засварын хүсэлтийг нэг системд удирдах веб платформ.', url: 'https://gamu666.github.io/content-factory/', address: 'gamu666.github.io/content-factory', poster: null, gradient: 'radial-gradient(circle at 50% 28%, rgba(31,143,255,.58), transparent 40%), linear-gradient(135deg, #071321 0%, #0f2d4d 50%, #08192c 100%)' },
